...
public class MemberUpdateRequestDto {
    ...
    public MemberUpdateRequestDto(Long mem_no, String id, String pw, String name, String
            birth, String nickname, String img, LocalDateTime rdate, LocalDateTime wdate, String sns, String msg, Role role) {
        this.mem_no = mem_no;
        this.id = id;
        this.pw = pw;
        this.name = name;
    ...
    public Member toEntity() {
        return Member.builder().mem_no(mem_no).id(id).pw(pw).birth(birth).nickname(nickname).img(img).rdate(rdate).wdate(wdate).sns(sns).msg(msg).role(role).build();
    }
