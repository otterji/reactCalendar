...
public class ChannelUpdateRequestDto {
    ...
    @Builder
    public ChannelUpdateRequestDto(Long ch_no, String id, String pw, String name, String nickname, String img, LocalDateTime rdate, LocalDateTime wdate, String sns, String msg, Role role) {
        this.ch_no = ch_no;
        this.id = id;
        this.pw = pw;
        this.name = name;
